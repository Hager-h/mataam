...
export default function About() {
  ...
  return (
    ...
    <img src={imgabout} alt="" />
          ...
          <p><i ><AiOutlineCheck/></i> Etiam sed dolor ac diam volutpat.
          </p>
            <p><i ><AiOutlineCheck/></i> Erat volutpat aliquet imperdiet.

            </p>
            <p><i ><AiOutlineCheck/></i> purus a odio finibus bibendum.
            </p>
          <button className="btn buttn ">LEARN MORE</button>
...
difference whether he is rich or poor.
    ...
    <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam et purus a odio
      ...
      <a className="watch" href="https://www.youtube.com/watch?v=bZx8rPd-PKQ" target="_blank" rel="noreferrer"><i><BsFillPlayFill /></i> Watch Our Story</a>
    </div>
